...
- src/components/content-generation/ContentGeneration.tsx - Main content generation component with modal workflow
...
- src/services/**tests**/claudeService.test.ts - Claude API service tests
